...
import Mavet.PageObjects.RemovePort;
import net.sourceforge.tess4j.TesseractException;

public class DeletePort extends BaseTest {
	@Test
	public void deletePort() throws IOException, TesseractException, InterruptedException {
		...
		RemovePort port = new RemovePort(driver);
		port.removePort();
	}
}
