...
public class OutOfficeDelegation extends AbstractComponent{
	...
	public void outOfOfficeDelegation() throws InterruptedException, FileNotFoundException {
		...
		clickSubstituteUser.sendKeys("josefa54@yopmail.com");
		...
		saveBtn.click();
		Thread.sleep(5000);
		String subject="//div[contains(text(),'Out of Office Delegation: Josefa Reichel')]";
		verificationLink("josefa54@yopmail.com",subject);
	}
}
