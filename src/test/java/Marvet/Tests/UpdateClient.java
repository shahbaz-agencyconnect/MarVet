...
import Mavet.PageObjects.EditClient;
import Mavet.PageObjects.LandingPage;
import net.sourceforge.tess4j.TesseractException;

public class UpdateClient extends BaseTest{
	@Test
	public void updateClient() throws IOException, TesseractException, InterruptedException {
		...
		EditClient client = new  EditClient(driver);
		client.editClient();
	}
