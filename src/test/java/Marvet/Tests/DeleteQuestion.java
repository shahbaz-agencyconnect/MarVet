...
public class DeleteQuestion extends BaseTest{
	@Test
	public void deleteQuestion() throws IOException, TesseractException, InterruptedException {
		...
		RemoveQuestion question = new RemoveQuestion(driver);
