...
import Mavet.PageObjects.RemoveSection;
import net.sourceforge.tess4j.TesseractException;

public class DeleteSection extends BaseTest{
	@Test
	public void deleteSection() throws IOException, TesseractException, InterruptedException {
		...
		RemoveSection section = new RemoveSection(driver);
