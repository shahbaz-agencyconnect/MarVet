...
import Mavet.PageObjects.AddSection;
import Mavet.PageObjects.LandingPage;
import net.sourceforge.tess4j.TesseractException;

public class CreateNewSection extends BaseTest {
	@Test
	public void createSection() throws IOException, TesseractException, InterruptedException {
		...
		AddSection section = new AddSection(driver);
		section.addSection();
	}
}
