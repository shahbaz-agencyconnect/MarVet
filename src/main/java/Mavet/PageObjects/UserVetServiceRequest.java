...
public class UserVetServiceRequest extends AbstractComponent {
	WebDriver driver;

	public UserVetServiceRequest(WebDriver driver) {
		super(driver);
		this.driver = driver;
		PageFactory.initElements(driver, this);
	}

	@FindBy(xpath = "//span[text()=' User Vet ']")
	WebElement userVet;
	...
	public void userVetRequest() throws IOException, TesseractException, InterruptedException {
		ArrayList<String> vesselEntries = excelRead("UserVet Service Request");
